...
License & attribution
- This README was created based on the provided MainData.java source.
- Author of code: as implied by file header comments (USER / lishengshun).
- README author: generated by an assistant for the contents of MainData.java.
